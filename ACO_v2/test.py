...
# Generate the data
data = [[0.0] * cols for _ in range(rows)]  # Initialize a matrix of size rows x cols filled with zeros
for i in range(rows):
    for j in range(cols):
        if i != j:  # Ensure diagonal elements are zeros
            data[i][j] = generate_random()

# Print the generated data
print(data)

var = [[0.00, 0.69, 0.56, 0.79, 0.74, 0.24, 0.25, 0.75, 0.42, 0.79, 0.21, 0.86, 0.97, 0.1, 0.02, 0.36, 0.38, 0.8, 0.33,
        0.51, 0.35, 0.00],
       [0.00, 0.0, 0.37, 0.25, 0.47, 0.3, 0.44, 0.99, 0.64, 0.59, 0.61, 0.79, 0.97, 0.99, 0.65, 0.77, 0.02, 0.27, 0.9,
        0.23, 0.46, 0.76],
       [0.00, 0.49, 0.00, 0.14, 0.28, 0.41, 0.97, 0.79, 0.45, 0.79, 0.62, 0.04, 0.16, 0.88, 0.85, 0.26, 0.83, 0.08, 0.27,
        0.81, 0.56, 0.95],
       ...
       [0.00, 0.2, 0.44, 0.96, 0.39, 0.43, 0.86, 0.14, 0.45, 0.7, 0.71, 0.19, 0.75, 0.0, 0.3, 0.77, 0.79, 0.42, 0.26,
        0.67, 0.26, 0.83],
       [0.00, 0.84, 0.03, 0.53, 0.73, 0.06, 0.59, 0.58, 0.05, 0.48, 0.36, 0.37, 0.56, 0.26, 0.0, 0.15, 0.91, 0.42, 0.99,
        0.34, 0.11, 0.42],
       [0.00, 0.37, 0.48, 0.04, 0.73, 0.35, 0.35, 0.74, 0.72, 0.34, 0.16, 0.01, 0.57, 0.78, 0.45, 0.0, 0.71, 0.56, 0.47,
        0.37, 0.56, 0.39],
